 ...
 */
public class VerilogLanguageSupport extends AbstractLanguageSupport {
	 ...
	 */
	private VerilogCompletionProvider provider = null;
	/**
	 * Syntax Checker
	 */
	 ...
	 * @return the provider
	 */
	public VerilogCompletionProvider getProvider() {
		if ( provider == null ) {
			provider = new VerilogCompletionProvider();
		}
		return provider;
	}
