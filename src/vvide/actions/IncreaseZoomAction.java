...
/**
 * An Action to increase the Zoom
 */
public class IncreaseZoomAction extends AbstractAction {
	 ...
	 * Version UID
	 */
	private static final long serialVersionUID = -1869872142932829290L;
	/**
	 * Zoom listener
	 */
	...
	public IncreaseZoomAction() {
		super( "Increase Zoom" );
		putValue( SHORT_DESCRIPTION, "Increase the zoom factor" );
	...
	private class ZoomListener implements PropertyChangeListener {
		...
		public void propertyChange( PropertyChangeEvent evt ) {
			setEnabled( waveView.isDisplayable()
				&& waveView.getZoom() > waveView.getMaximalZoom() );
		}
	}
}
