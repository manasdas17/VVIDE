...
public class FindTextAction extends AbstractSearchAction {
	 ...
	 * Version UID
	 */
	private static final long serialVersionUID = 5613402547338472619L;
	...
	public void actionPerformed( ActionEvent e ) {
		...
		boolean status = SearchEngine.find( codeEditor, dialog.getSearchText(), dialog
				.isForward(), dialog.isCaseSesitive(), dialog.isWholeWord(),
				dialog.isRegularExpression() );
		dialog.setStatusText( (status) ? "Text found" : "No more coincidences found" );
	}
}
