...
import vvide.ui.views.editor.SearchDialog;
import vvide.utils.CommonMethods;

/**
 * Action to search/replace
 */
public class SearchReplaceAction extends AbstractAction {
	 ...
	 * Version UID
	 */
	private static final long serialVersionUID = -8742976729836471989L;
	/**
	 * Search dialog
	 */
	private static SearchDialog searchDialog = null;
	...
	public SearchReplaceAction() {
		...
		putValue( SHORT_DESCRIPTION, "Show a search/replace dialog" );
	...
	public void actionPerformed( ActionEvent e ) {
		...
		String selectedText = CommonMethods.getCurrentEditor().getSelectedText(); 
	...
	/**
	 * Notify action that the dialog is closed
	 */
