...
/**
 * Action set Normal zoom (1 px = 1 TimeEntity)
 */
public class NormalZoomAction extends AbstractAction {
	 ...
	 * Constructor
	 */
	public NormalZoomAction() {
		super( "Normal Zoom" );
		putValue( SHORT_DESCRIPTION, "Set default zoom (1px = 1TimeEntity)" );
		putValue( ACCELERATOR_KEY, KeyStroke.getKeyStroke(
				KeyEvent.VK_MULTIPLY, Toolkit.getDefaultToolkit()
						.getMenuShortcutKeyMask() ) );
		putValue( LARGE_ICON_KEY, new ImageIcon( getClass().getResource(
				"/img/actions/zoom_1.png" ) ) );
	...
	public void actionPerformed( ActionEvent e ) {
		if ( waveView.isDisplayable() )
			waveView.setZoom( waveView.getDefaultZoom() );
	}
}
